...
class AdminTheme {
  static ThemeData get light => ThemeData(
    ...
    cardTheme: CardTheme(color: AdminColors.cardBg, elevation: 1, shadowColor: Colors.black.withOpacity(0.08), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)), margin: EdgeInsets.zero),
